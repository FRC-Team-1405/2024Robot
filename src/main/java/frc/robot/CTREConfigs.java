...
public final class CTREConfigs {
    ...
    public CTREConfigs(){
        ...
        // swerveAngleFXConfig.withFeedback(new FeedbackConfigs());
        // swerveAngleFXConfig.Feedback.FeedbackRemoteSensorID = 21; testing setting feed forward sensor id, encoder id
        ...
        swerveAngleFXConfig.CurrentLimits.withStatorCurrentLimit(Constants.Swerve.angleCurrentThreshold);
        swerveAngleFXConfig.CurrentLimits.withSupplyCurrentLowerTime(Constants.Swerve.angleCurrentThresholdTime);
        ...
        swerveDriveFXConfig.CurrentLimits.withStatorCurrentLimit(Constants.Swerve.driveCurrentThreshold);
        swerveDriveFXConfig.CurrentLimits.withSupplyCurrentLowerTime(Constants.Swerve.driveCurrentThresholdTime);
